...
### Файлы ConfigReader.h и main.cpp должны быть добавлены в examin (src). С помощью данной подсистемы можно проводить эксперименты с заданными настройками.
### Ради демонстрации можно воспользоваться папкой example, которая имитирует директорию сборки общего проекта Globalizer. Целевое приложение: 
                                                 ..\example\BridgeM.exe 
