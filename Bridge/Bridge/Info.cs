...
">=0                                                   ",
">=0                                                   ",
"Перечисление ELocalMethodScheme или значение от 0 до ",
">=0                                                  ",
">0                                                   ",
...
"точность для критерия остановки,\r\n общее значение для всех уровней дерева процессов     ",
"начальная оценка константы Липшица                                                    ",
"плотность построения развертки (точность 1/2^m по координате)                         ",
"кол-во используемых ускорителей                                               ",
"тип развертки (сдвиговая, вращаемая)                                          ",
"число уровней в дереве задач,совпадает с NumOfProcLevels                      ",
"число размерностей на каждом уровне дерева задач .\r\nразмер: NumOfTaskLevels     ",
...
"путь, по которому будут сохранены многомерные точки,\r\n поставленные методом корневого процесса                     ",
"флаг, включающий печать дополнительной статистики:\r\n оценки констант Гёльдера и значения функций в точке оптимума  ",
"флаг, выключающий печать\r\n параметров при запуске системы                                                          ",
"префикс в имени лог-файла                                                                                        ",
"тип способа решения задачи                                                                                       ",
"размерности каждой из подзадач в режиме\r\n сепарабильного или сикуенсального поиска                                 ",
"параметры свертки                                                                                                ",
"параметры свертки                                                                                                ",
